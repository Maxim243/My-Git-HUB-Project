...
import automation.services.dto.repoDTO.getDTO.PermissionsDTO;
...
@Getter
@Setter
public class UpdateGitHubDTO extends BaseResponseDTO {
    private int id;
    ...
    private Object license; // Replace "Object" with the actual data type for the license field
    ...
    private SecurityAndAnalysisDTO security_and_analysis;
}
